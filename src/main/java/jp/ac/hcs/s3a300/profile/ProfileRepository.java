...
public class ProfileRepository {
	...
	private static final String SQL_UPDATE_PROFILE_ONE = "UPDATE m_user SET qualification = ?, nickname = ?, comment = ? WHERE user_id = ?";
	...
	public int  updateProfile(ProfileData data) throws DataAccessException {
		int rowNumber = -1;
		rowNumber = jdbc.update(SQL_UPDATE_PROFILE_ONE,
