...
public class UserRepository {
	...
	/** SQL 1件追加 */
	private static final String SQL_INSERT_ONE = "INSERT INTO m_user(user_id, encrypted_password, user_name, enabled, qualification, nickname, comment, role) VALUES(?, ?, ?, ?, ?, ?, ?, ?)";
	...
	private static final String SQL_UPDATE_DETAIL_ONE = "UPDATE m_user SET user_name = ?, role = ? WHERE user_id = ?";
	...
	public int updateOne(UserData userData) throws DataAccessException {
		int rowNumber = jdbc.update(SQL_UPDATE_DETAIL_ONE,
